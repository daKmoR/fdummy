...
$TCA['tx_gridelements_backend_layout'] = array(
	...
	'columns' => array(
		...
		'title' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.title',
			'config' => array(
				'type' => 'input',
				'size' => '25',
				'max' => '256',
		...
		'description' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.description',
			'config' => array(
				'type' => 'text',
				'rows' => '5',
			)
		...
		'icon' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.icon',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'file',
				'allowed' => 'jpg,gif,png',
		...
		'frame' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.frame',
			'config' => array(
				'type' => 'select',
				'items' => array(
		...
		'top_level_layout' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.top_level_layout',
			'config' => array(
				'type' => 'check',
				'items' => array (
					'1'	=> array(
		...
		'config' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.config',
			'config' => array(
				'type' => 'text',
				'cols' => '25',
				'rows' => '5',
		...
		'pi_flexform_ds' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.pi_flexform_ds',
			'config' => array(
				'type' => 'text',
				'cols' => '35',
				'rows' => '10'
	...
	'palettes' => array(
		...
		'visibility' => array('canNotCollapse' => 1, 'showitem' => 'hidden;LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout',),
	),
	'types' => array(
		'1' => array(
			'showitem' => 
				...
				--div--;LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.div.configuartion, top_level_layout, config, pi_flexform_ds,
