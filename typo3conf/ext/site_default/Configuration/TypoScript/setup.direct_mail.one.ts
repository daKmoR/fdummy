<INCLUDE_TYPOSCRIPT: source="FILE: fileadmin/templates/common/direct_mail/ts/setup.OneColumn.ts">

# set your OWN css if needed
page.10.css.10.file = fileadmin/templates/default/direct_mail/css/OneColumn.css

# use own plaintext file if needed
tx_directmail_pi1.10.template.file = fileadmin/templates/default/direct_mail/OneColumn.txt
